...
Error resolved - metajam is working for me now, so everything done below with `alaska_data_m` (manual download) could be repeated identically with the same data using `metajam`, which is now stored in `alaska_df` above.
